import 'package:e_commerce_app/Distributor/distributor_dashboard/distributer_invoice_screen/distributer_invoice_detail_screen/distributer_invoice_detail_screen.dart';
...
class DistributerInvoiceScreen extends StatelessWidget {
  const DistributerInvoiceScreen({super.key});
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(padding: EdgeInsets.symmetric(horizontal: 24,vertical: 10),
        ...
        child: SingleChildScrollView(
          ...
          child: DataTable(headingRowColor: WidgetStateColor.resolveWith((states) => Colors.grey),headingRowHeight: 40,
            columnSpacing: 30,
            columns: [
            ...
            rows: [
              DataRow(cells: [
                DataCell(InkWell(onTap: (){Get.to(DistributerInvoiceDetailScreen());},child: Poppins('#455111',fontSize: 14,fontWeight: FontWeight.w400,color: Colors.grey[700],))),
              ...
              DataRow(cells: [
                DataCell(InkWell(onTap: (){DistributerInvoiceDetailScreen();},child: Poppins('#485111',fontSize: 14,fontWeight: FontWeight.w400,color: Colors.grey[700],))),
                DataCell(Poppins('11/11/2024',fontSize: 14,fontWeight: FontWeight.w400,color: Colors.grey[700],)),
