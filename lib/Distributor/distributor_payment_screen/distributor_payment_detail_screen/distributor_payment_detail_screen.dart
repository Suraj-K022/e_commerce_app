...
class DistributorPaymentDetailScreen extends StatefulWidget {
  const DistributorPaymentDetailScreen({super.key});

  @override
  State<DistributorPaymentDetailScreen> createState() => _DistributorPaymentDetailScreenState();
}

class _DistributorPaymentDetailScreenState extends State<DistributorPaymentDetailScreen> {
