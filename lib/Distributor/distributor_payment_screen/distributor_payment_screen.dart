...
import 'distributor_payment_detail_screen/distributor_payment_detail_screen.dart';
          ...
          SingleChildScrollView(padding: EdgeInsets.symmetric(vertical: 24),
            ...
            child: SingleChildScrollView(
              ...
              child: DataTable(headingRowColor: WidgetStateColor.resolveWith((states) => Colors.grey),headingRowHeight: 40,
                ...
                rows: [
                  DataRow(cells: [
                    DataCell(InkWell(onTap: (){Get.to(DistributorPaymentDetailScreen());},child: Poppins('11/11/2024',fontSize: 14,fontWeight: FontWeight.w400,color: Colors.grey[700],))),
