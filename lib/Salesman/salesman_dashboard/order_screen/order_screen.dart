      ...
      body: SingleChildScrollView(padding: EdgeInsets.symmetric(horizontal: 24,vertical: 10),
        ...
        child: SingleChildScrollView(
          ...
          child: DataTable(headingRowColor: WidgetStateColor.resolveWith((states) => Colors.grey),
            ...
            rows: [
              DataRow(cells: [
                DataCell(InkWell(onTap: (){Get.to(OrderDetailScreen());},child: Poppins('#455111',fontSize: 14,fontWeight: FontWeight.w400,color: Colors.grey[700],))),
              ...
              DataRow(cells: [
                DataCell(InkWell(onTap: (){Get.to(OrderDetailScreen());},child: Poppins('#485111',fontSize: 14,fontWeight: FontWeight.w400,color: Colors.grey[700],))),
                DataCell(Poppins('11/11/2024',fontSize: 14,fontWeight: FontWeight.w400,color: Colors.grey[700],)),
