...
class ProductAvailableScreen extends StatefulWidget {
  const ProductAvailableScreen({super.key});

  @override
  State<ProductAvailableScreen> createState() => _ProductAvailableScreenState();
}

class _ProductAvailableScreenState extends State<ProductAvailableScreen> {
  int screen = 0;
