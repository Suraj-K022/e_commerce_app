  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      ListView(padding: EdgeInsets.symmetric(horizontal: 24,vertical: 20),
        children: [
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Poppins('Invoice ID #',fontSize: 16,fontWeight: FontWeight.w500,color: Get.theme.secondaryHeaderColor,), Poppins('ED-T/12',fontSize: 16,fontWeight: FontWeight.w400,color: Colors.grey[700],),],),
          ...
          Divider(color: Colors.grey,height: 20,thickness: 1,),
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Poppins('Retailer Name',fontSize: 16,fontWeight: FontWeight.w500,color: Get.theme.secondaryHeaderColor,), Poppins('Aman Jain',fontSize: 16,fontWeight: FontWeight.w400,color: Colors.grey[700],),],),
          Divider(color: Colors.grey,height: 20,thickness: 1,),
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Poppins('Order',fontSize: 16,fontWeight: FontWeight.w500,color: Get.theme.secondaryHeaderColor,), Poppins('Unpaid',fontSize: 16,fontWeight: FontWeight.w400,color: Colors.grey[700],),],),
