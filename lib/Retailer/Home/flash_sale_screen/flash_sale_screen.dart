  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      GridView(
        ...
        InkWell(onTap: (){Get.to(ProductDetailScreen());},child: CustomCard(imageUrl:( 'assets/images/image9.png'), titleText: 'Blue Western Dress', dynamicText1: '₹1,000', dynamicText2: '₹800', star: '3.5',text: '-20%',)),
        InkWell(onTap: (){Get.to(ProductDetailScreen());},child: CustomCard(imageUrl:( 'assets/images/image10.png'), titleText: 'Kurta & Pants Set', dynamicText1: '₹1,000', dynamicText2: '₹800', star: '3.5',text: '-20%',)),
        InkWell(onTap: (){Get.to(ProductDetailScreen());},child: CustomCard(imageUrl:( 'assets/images/image11.png'), titleText: 'Ankle-Length Leggings', dynamicText1: '₹1,000', dynamicText2: '₹800', star: '3.5',text: '-20%',)),
        InkWell(onTap: (){Get.to(ProductDetailScreen());},child: CustomCard(imageUrl:( 'assets/images/image12.png'), titleText: 'Floral Kurta with Dupatta', dynamicText1: '₹1,000', dynamicText2: '₹800', star: '3.5',text: '-20%',)),
